...
## **Working papers**
---
##### **Payments and Cash Management in the Euro Area: Data, Theory and Quantitative Analysis** <small> <a target="_blank" href="{{ '/assets/pdf/cash-management-payment-choices.pdf' | prepend: site.baseurl | prepend: site.url }}"> (Draft) </a> </small>
...
***with Silvio Sorbera***
<p style="text-align: justify;"> We study theoretically the acceptance and usage of cashless payments, as well as its interaction with the transactions demand for cash, in an economy where buyers and sellers meet in order to exchange goods and services. Buyers decide how much cash to hold, and they have the option to use a cashless payment device to settle purchases; sellers decide whether to accept cash payments only or to allow their customers to use cards. </p>
